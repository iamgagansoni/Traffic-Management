...
import numpy as np
# Load Yolo
net = cv2.dnn.readNet("Car Detection\yolov3.weights", "Car Detection\yolov3.cfg") #specify the path for weight and cfg file
classes = []
with open("Car Detection\coco.names", "r") as f:
